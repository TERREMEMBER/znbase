...
PG_KEYWORD("authorize", AUTHORIZE, RESERVED_KEYWORD)
...
PG_KEYWORD("clustering", CLUSTERING, UNRESERVED_KEYWORD)
...
PG_KEYWORD("compact", COMPACT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("counter", COUNTER, COL_NAME_KEYWORD)
PG_KEYWORD("covering", COVERING, UNRESERVED_KEYWORD)
...
PG_KEYWORD("date", DATE, COL_NAME_KEYWORD)
...
PG_KEYWORD("error", ERROR, UNRESERVED_KEYWORD)
...
PG_KEYWORD("filtering", FILTERING, UNRESERVED_KEYWORD)
...
PG_KEYWORD("frozen", FROZEN, COL_NAME_KEYWORD)
...
PG_KEYWORD("group", GROUP_P, COL_NAME_KEYWORD)
...
PG_KEYWORD("keyspace", KEYSPACE, RESERVED_KEYWORD)
PG_KEYWORD("keyspaces", KEYSPACES, RESERVED_KEYWORD)
...
PG_KEYWORD("list", LIST, COL_NAME_KEYWORD)
...
PG_KEYWORD("login", LOGIN, UNRESERVED_KEYWORD)
PG_KEYWORD("logged", LOGGED, UNRESERVED_KEYWORD)
PG_KEYWORD("map", MAP, COL_NAME_KEYWORD)
...
PG_KEYWORD("nan", NAN, RESERVED_KEYWORD)
...
PG_KEYWORD("offset", OFFSET, COL_NAME_KEYWORD)
...
PG_KEYWORD("permission", PERMISSION, UNRESERVED_KEYWORD)
PG_KEYWORD("permissions", PERMISSIONS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("static", STATIC, UNRESERVED_KEYWORD)
PG_KEYWORD("statistics", STATISTICS, UNRESERVED_KEYWORD)
PG_KEYWORD("status", STATUS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("superuser", SUPERUSER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("text", TEXT_P, COL_NAME_KEYWORD)
PG_KEYWORD("then", THEN, RESERVED_KEYWORD)
PG_KEYWORD("time", TIME, COL_NAME_KEYWORD)
PG_KEYWORD("timestamp", TIMESTAMP, COL_NAME_KEYWORD)
PG_KEYWORD("timeuuid", TIMEUUID, COL_NAME_KEYWORD)
PG_KEYWORD("tinyint", TINYINT, COL_NAME_KEYWORD)
PG_KEYWORD("to", TO, RESERVED_KEYWORD)
PG_KEYWORD("token", TOKEN, RESERVED_KEYWORD)
PG_KEYWORD("tuple", TUPLE, COL_NAME_KEYWORD)
PG_KEYWORD("partition_hash", PARTITION_HASH, RESERVED_KEYWORD)
...
PG_KEYWORD("ttl", TTL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("uuid", UUID, COL_NAME_KEYWORD)
...
PG_KEYWORD("varint", VARINT, COL_NAME_KEYWORD)
...
PG_KEYWORD("when", WHEN, UNRESERVED_KEYWORD)
