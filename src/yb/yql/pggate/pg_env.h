...
// Although postgres libraries might handle most of the environment variables, ZNbase libraries
// might need to deal with some of them. This class is provided for that reason.  This class can
// be removed if ZNbase layers, especially DocDB, do not handle any custom values for ENV.
