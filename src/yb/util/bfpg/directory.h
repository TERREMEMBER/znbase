...
//   - "+" is a PGSQL function, a builtin method.
//   - STRING of type yb::DataType represents the return type of the PGSQL "+" function.
//   - { STRING, STRING } represents the signature of the PGSQL "+" function.
...
#ifndef YB_UTIL_BFPG_DIRECTORY_H_
#define YB_UTIL_BFPG_DIRECTORY_H_

#include <vector>

#include "yb/util/bfpg/bfdecl.h"
...
#endif  // YB_UTIL_BFPG_DIRECTORY_H_
