...
class PartitionSchema {
 public:
  ...
  // - ZNbase methods are used for hash and range partitioning to create tablets.
  //
  ...
  // to ZNbase's database except for metadata in master, which is using Kudu's DB.
  //
