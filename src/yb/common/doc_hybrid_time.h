...
// This is a point in time before any ZNbase clusters are in production that has a round enough
...
constexpr HybridTimeRepr kZNbaseMicrosecondEpoch = 1500000000ul * 1000000;
