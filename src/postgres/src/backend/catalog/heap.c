			...
			bool allow_system_table_mods)
{
	...
	/*
	 * No need to create local storage for YB Tables as ZNbase will handle it.
	 * Temporary tables in ZNbase mode use local storage.
...
heap_drop_with_catalog(Oid relid)
{
	 ...
	 * If ZNbase is enabled, there aren't any physical files to remove.
	 */
	if (!IsZNbaseEnabled() &&
