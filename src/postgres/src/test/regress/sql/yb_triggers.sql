...
-- Note: The ZNbase behavior in this case is different from vanilla Postgres.
...
--  * However, in ZNbase this is allowed and both changes are applied to the row in the
