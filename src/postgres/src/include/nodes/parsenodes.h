 ...
 *
 * When a ZNbase LSM primary key or index declaration contains an attribute
...
typedef struct Constraint
{
	...
	/* For ZNbase LSM primary or unique key defined inline with the table
...
/* ----------
 * ZNbase split parameters in CreateStmt
 *
 * In ZNbase, tables are split into a certain number of tablets.
