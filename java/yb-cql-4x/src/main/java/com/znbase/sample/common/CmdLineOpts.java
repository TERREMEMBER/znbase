...
package com.ZNbase.sample.common;
...
import com.ZNbase.sample.apps.*;
import com.ZNbase.sample.apps.AppBase.TableOp;
...
public class CmdLineOpts {
  ...
  private static Class<? extends AppBase> getAppClass(String workloadType)
    ...
    return Class.forName("com.ZNbase.sample.apps." + workloadType)
  ...
  public static CmdLineOpts createFromArgs(String[] args) throws Exception {
    ...
    options.addOption("disable_yb_load_balancing_policy", false,
        "Disable ZNbase load-balancing policy.");
    ...
    options.addOption("concurrent_clients", true,
        "The number of client connections to establish to each host in the ZNbase DB cluster.");
    options.addOption("ssl_cert", true,
      "Use an SSL connection while connecting to ZNbase.");
  ...
  private static void printUsage(Options options, String header) throws Exception {
    ...
    footer.append("****************************************************************************\n");
    footer.append("*                                                                          *\n");
    footer.append("*                     ZNbase DB Sample Apps                              *\n");
    footer.append("*                                                                          *\n");
    footer.append("****************************************************************************\n");
    footer.append("\n");
    footer.append("Use this sample app to try out a variety of workloads against ZNbase DB.\n");
  ...
  private static void printUsageDetails(Options options, String header, String appName)
    ...
    footer.append("Usage and options for workload " + appName + " in ZNbase DB Sample Apps.\n");
    String optsPrefix = "\t\t\t";
    String optsSuffix = " \\\n";
