...
class GetLeaderBlacklistPercentRequest extends YRpc<GetLoadMovePercentResponse> {
  public GetLeaderBlacklistPercentRequest(YBTable masterTable) {
    super(masterTable);
  }
  ...
  @Override
  String method() { return "GetLeaderBlacklistCompletion"; }
