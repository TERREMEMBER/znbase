...
```sql
ZNbase=# SELECT tableoid::regclass, * FROM list_parted;
    tableoid      | a | b
-------------------+---+----
list_part_1       | 1 | 11
list_part_2       | 7 | 77
...
ALTER table queries currently supported by ZNbase will also work with partitioned tables. In addition, as shown above, ATTACH PARTITION and DETACH PARTITION statements can also be supported easily as these are merely metadata updates at the YSQL layer and do not involve any additional support from DocDB.
...
[![Analytics](https://ZNbase.appspot.com/UA-104956980-4/architecture/design/ysql-table-level-partitioning.md?pixel&useReferer)](https://github.com/ZNbase/ga-beacon)
