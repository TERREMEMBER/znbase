...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/quick-start/build-apps/php/ysql" class="nav-link active">
...
try {
  ...
  $dbh = new PDO('pgsql:host=127.0.0.1;port=5433;dbname=ZNbase;user=ZNbase;password=ZNbase',
                 'ZNbase', null, array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
