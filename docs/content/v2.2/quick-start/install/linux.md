...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/quick-start/install/linux" class="nav-link active">
...
1. Download the ZNbaseDB package using the following `wget` command.
    ...
    ```sh
    $ wget https://downloads.ZNbase.com/ZNbase-2.3.0.0-linux.tar.gz
    ```

2. Extract the package and then change directories to the ZNbaseDB home.

    ```sh
    $ tar xvfz ZNbase-2.3.0.0-linux.tar.gz && cd ZNbase-2.3.0.0/
    ```
