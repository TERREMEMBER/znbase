...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/v2.2/ZNbase-platform/configure-ZNbase-platform/set-up-cloud-provider/aws" class="nav-link active">
  ...
  <li>
    <a href="/v2.2/ZNbase-platform/configure-ZNbase-platform/set-up-cloud-provider/on-premises" class="nav-link">
...
- Attach an [IAM role](https://docs.aws.amazon.com/AWSEC2/stable/UserGuide/iam-roles-for-amazon-ec2.html) to the ZNbase Platform VM in the **EC2** tab.
