...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/v2.2/ZNbase-platform/configure-ZNbase-platform/set-up-cloud-provider/gcp" class="nav-link active">
...
- Upload the JSON file that you obtained when you created your service account in [Prepare the Google Cloud Platform (GCP) environment](../../../install-ZNbase-platform/prepare-environment/gcp).
