...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/v2.2/ZNbase-platform/configure-ZNbase-platform/set-up-cloud-provider/vmware-tanzu" class="nav-link active">
      <i class="fas fa-cubes" aria-hidden="true"></i>
      VMware Tanzu
    </a>
  </li>
...
Based on what cloud providers you have setup in your ZNbase Platform, you can create ZNbase service instances by providing the overrides as below.
