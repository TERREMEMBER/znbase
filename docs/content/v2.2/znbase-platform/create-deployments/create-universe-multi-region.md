...
Export an environment variable telling us the IP addresses for nodes in the cluster. Browse to the **Universe Overview** tab in ZNbase Platform console and click on the `YCQL Endpoints` link. This should open a new tab with a list of IP addresses. 
