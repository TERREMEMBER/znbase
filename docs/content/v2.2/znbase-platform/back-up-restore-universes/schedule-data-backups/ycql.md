...
Use ZNbase Platform to perform regularly scheduled backups of ZNbaseDB universe data for all YCQL tables in a keyspace or only the specified YCQL tables.
