...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/v2.2/ZNbase-platform/install-ZNbase-platform/prepare-environment/aws" class="nav-link">
  ...
  <li>
    <a href="/v2.2/ZNbase-platform/install-ZNbase-platform/prepare-environment/gcp" class="nav-link active">
