...
description: Create and use colocated tables in a local ZNbaseDB cluster on Linux.
block_indexing: true
menu:
  v2.2:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/explore/colocated-tables/macos" class="nav-link">
  ...
  <li >
    <a href="/v2.2/explore/colocated-tables/linux" class="nav-link active">
