...
description: Learn how to scale a local three-node ZNbaseDB cluster (on macOS) while a workload is running.
block_indexing: true
menu:
  v2.2:
...
The workload application prints some stats while running, an example is shown here. You can read more details about the output of the sample applications [here](https://github.com/ZNbase/yb-sample-apps).
