...
description: Simulate fault tolerance and resilience in a local three-node ZNbaseDB cluster on macOS.
block_indexing: true
menu:
  v2.2:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/explore/fault-tolerance/macos" class="nav-link active">
  ...
  <li >
    <a href="/v2.2/explore/fault-tolerance-kubernetes" class="nav-link">
...
The `SqlInserts` workload prints some statistics while running, which is also shown below. You can read more details about the output of the workload applications at the [ZNbaseDB workload generator](https://github.com/ZNbase/yb-sample-apps).
