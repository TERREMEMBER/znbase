...
description: Follow this tutorial (on Kubernetes) to learn how ZNbaseDB automatically splits tables into shards (tablets).
block_indexing: true
menu:
  v2.2:
...
<!--
  <li >
    <a href="/v2.2/explore/auto-sharding-kubernetes" class="nav-link active">
