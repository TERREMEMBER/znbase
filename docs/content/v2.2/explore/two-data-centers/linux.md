...
description: Simulate a geo-distributed two data center (2DC) deployment with two local ZNbaseDB clusters on Linux.
block_indexing: true
menu:
  v2.2:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/explore/two-data-centers/macos" class="nav-link">
  ...
  <li >
    <a href="/v2.2/explore/two-data-centers/linux" class="nav-link active">
