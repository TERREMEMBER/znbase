...
description: How to migrate PostgreSQL schema to ZNbaseDB.
block_indexing: true
menu:
  v2.2:
...
{{< note title="Note" >}}
Altering the primary key of a table after creation is a planned feature, the current status of this enhancement is tracked [here](https://github.com/ZNbase/ZNbase-db/issues/1104).
{{< /note >}}
