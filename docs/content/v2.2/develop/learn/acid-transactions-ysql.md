...
description: Learn how ACID transactions work in YSQL on ZNbaseDB.
block_indexing: true
menu:
  v2.2:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/v2.2/develop/learn/acid-transactions-ysql" class="nav-link active">
  ...
  <li >
    <a href="/v2.2/develop/learn/acid-transactions-ycql" class="nav-link">
