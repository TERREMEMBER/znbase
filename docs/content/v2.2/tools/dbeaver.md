---
title: Use DBeaver with ZNbaseDB YSQL
headerTitle: DBeaver
linkTitle: DBeaver
description: Use the DBeaver multi-platform database tool to explore and query ZNbaseDB.
block_indexing: true
menu:
  v2.2:
    identifier: dbeaver
