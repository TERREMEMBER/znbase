...
To install and use the Chinook sample database, you need to have installed and configured ZNbaseDB. To get up and running quickly, see [Quick Start](/v2.2/quick-start/).
