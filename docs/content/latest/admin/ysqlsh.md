...
* Using Docker:
    ...
    ```sh
    docker run -it ZNbasedb/ZNbase-client ysqlsh -h <hostname> -p <port>
    ```

* Using Homebrew:

    ```sh
    brew tap ZNbase/ZNbasedb
    brew install ZNbasedb-client
    ysqlsh
    ```
...
* Using a shell script:
    ...
    ```sh
    wget -q -O - https://downloads.ZNbase.com/get_clients.sh | sh 
    ZNbase*/bin/ysqlsh
    ```
