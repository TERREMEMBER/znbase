...
Although the values of a parameter can be set, displayed, and reset, the effect of these parameters are not yet supported in ZNbaseDB. The default settings and behaviors will be used for the moment.
