...
<a class="download-binary-link" href="https://downloads.ZNbase.com/ZNbase-2.0.10.0-darwin.tar.gz">
  <button>
    <i class="fab fa-apple"></i><span class="download-text">macOS</span>
  </button>
</a>
&nbsp; &nbsp; &nbsp; 
<a class="download-binary-link" href="https://downloads.ZNbase.com/ZNbase-2.0.10.0-linux.tar.gz">
  <button>
...
```sh
docker pull ZNbasedb/ZNbase:2.0.10.0-b4
```

## YSQL Changes

* [YSQL] Fixed an issue with PgDocOp lifespan sometimes being too short.
* [YSQL] "UPDATE" fails if any "NOT NULL" columns aren't updated [#3174](https://github.com/ZNbase/ZNbase-db/issues/3174)
* [YSQL] Force network library initialization on postmaster startup on macOS. [2509](https://github.com/ZNbase/ZNbase-db/issues/2509)
 

## YCQL Changes 

* [YCQL] Table stuck in the keyspace after deletion [#3032](https://github.com/ZNbase/ZNbase-db/issues/3032)



## System improvements

* Implement one way bitmap and Extract CleanupTransaction from YBTransaction. [#3220](https://github.com/ZNbase/ZNbase-db/issues/3220)
* Improved rocksdb corruption error logging. [#2961](https://github.com/ZNbase/ZNbase-db/issues/2961)
* Added TCMalloc stats when dumping memory usage. [#3190](https://github.com/ZNbase/ZNbase-db/issues/3190)
