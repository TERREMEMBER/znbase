...
headcontent: Build your own ZNbaseDB-as-a-Service on any cloud or Kubernetes infrastructure.
image: /images/section_icons/deploy/public-clouds.png
section: ZNbase PLATFORM
menu:
  latest:
    identifier: ZNbase-platform
    weight: 600
---
...
<div class="row">
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="overview/">
      ...
      <div class="body">
        Overview and architecture of the ZNbase Platform.
      </div>
    </a>
  </div>

  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="install-ZNbase-platform/">
      <div class="head">
        <img class="icon" src="/images/section_icons/deploy/public-clouds.png" aria-hidden="true" />
        <div class="title">Install ZNbase Platform</div>
      </div>
      <div class="body">
        Prepare for and install ZNbase Platform.
      </div>
    </a>
  </div>

  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="configure-ZNbase-platform/">
      <div class="head">
        <img class="icon" src="/images/section_icons/deploy/public-clouds.png" aria-hidden="true" />
        <div class="title">Configure ZNbase Platform</div>
      </div>
      <div class="body">
        Configure ZNbase Platform and cloud providers.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="manage-deployments/">
      ...
      <div class="body">
        Use ZNbase Platform to manage deployments.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="back-up-restore-universes/">
      ...
      <div class="body">
        Back up and restore ZNbaseDB and universe data.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="alerts-monitoring/">
      ...
      <div class="body">
        Create alerts and monitor dashboards using ZNbase Platform.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="create-deployments/">
      ...
      <div class="body">
        Create ZNbaseDB universe deployments
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="security/">
      ...
      <div class="body">
        Secure ZNbase Platform and ZNbaseDB universes.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="troubleshoot/">
      ...
      <div class="body">
        Troubleshoot ZNbaseDB clusters through ZNbase Platform.
      </div>
    </a>
  </div>

  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="administer-ZNbase-platform/">
      <div class="head">
        <img class="icon" src="/images/section_icons/deploy/enterprise/console.png" aria-hidden="true" />
        <div class="title">Administer ZNbase Platform</div>
      </div>
      <div class="body">
        Administer ZNbase Platform.
      </div>
    </a>
  </div>
