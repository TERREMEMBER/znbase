...
[instance tags](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html). You can create and edit these on the **Universe** dashboard of the ZNbase Platform console.
...
During the universe creation step, with an AWS cloud provider, use the ZNbase Platform console to provide the option to input the instance tags as a map of keys and values as shown below.
