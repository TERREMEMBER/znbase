...
First, enter the following values to create a primary cluster on [GCP](../../configure-ZNbase-platform/set-up-cloud-provider/gcp) provider. Click **Create Universe** and then enter the following intent.
...
cluster on [AWS](../../configure-ZNbase-platform/set-up-cloud-provider/aws/).
