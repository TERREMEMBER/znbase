...
linkTitle: Security
description: Secure ZNbase Platform and ZNbaseDB universes.
image: /images/section_icons/index/secure.png
headcontent: Secure ZNbase Platform and your ZNbaseDB universes.
menu:
  latest:
...
<div class="row">
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="security-checklist-yp/">
      ...
      <div class="body">
        Security considerations for ZNbase Platform and ZNbaseDB universes.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
   ...
   <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="authorization-platform/">
      ...
      <div class="body">
        Use ZNbase Platform to manager users and roles.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="enable-encryption-at-rest/">
      ...
      <div class="body">
        Use ZNbase Platform to enable encryption at rest and protect data in storage.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="enable-encryption-in-transit/">
      ...
      <div class="body">
        Use ZNbase Platform to enable encryption in transit using TLS and protect data between nodes and clients.
      </div>
    </a>
  </div>
