...
description: Use ZNbase Platform to back up data in YSQL tables.
aliases:
  - /latest/manage/enterprise-edition/backup-restore
  - /latest/manage/enterprise-edition/back-up-restore-data
  - /latest/ZNbase-platform/manage/backup-restore-data
  - /latest/ZNbase-platform/back-up-restore-universes/back-up-universe-data/
menu:
  latest:
...
Use ZNbase Platform to back up your ZNbaseDB universe YSQL data. To schedule backups for a later time, or as a recurring task, see [Schedule universe YSQL data backups](../../schedule-data-backups/ysql).

To immediately back up your ZNbaseDB universe YSQL data:
...
To allow ZNbase Platform to back up your data with user authentication enabled, follow the [instructions here](../../../manage-deployments/edit-config-flags) to add the following T-Server flags:
