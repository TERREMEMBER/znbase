...
description: Use ZNbase Platform to create scheduled backups of universe YSQL data.
aliases:
  - /latest/manage/enterprise-edition/schedule-backups/
  - /latest/manage/enterprise-edition/schedule-data-backup/
  - /latest/ZNbase-platform/back-up-restore-universes/schedule-data-backups/
menu:
  latest:
...
Use ZNbase Platform to perform regularly scheduled backups of ZNbaseDB universe data for all YSQL tables in a namespace. To back up your universe YCQL data immediately, see [Back up universe YSQL data](../../back-up-universe-data/ysql).

## Schedule a backup

To schedule a backup of your universe YSQL data:

1. Open the ZNbase Platform console and click **Universes** in the navigation bar.
