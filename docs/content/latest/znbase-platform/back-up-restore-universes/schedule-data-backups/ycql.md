...
description: Use ZNbase Platform to create scheduled backups of universe YCQL data.
menu:
  latest:
...
Use ZNbase Platform to perform regularly scheduled backups of ZNbaseDB universe data for all YCQL tables in a keyspace or only the specified YCQL tables. To back up your universe YCQL data immediately, see [Back up universe YCQL data](../../back-up-universe-data/ycql).

To schedule a backup of your universe YCQL data:

1. In the ZNbase Platform console, click **Universes** in the navigation bar.
