...
Depending on your cloud or on-premises environment, ZNbaseDB universe data can be saved to the following storage options.
...
2. While connected using `ssh`, create a directory `/backup` and then change the owner to `ZNbase`.
