...
description: Use ZNbase Platform to restore data in YSQL tables.
aliases:
  - /latest/ZNbase-platform/back-up-restore-databases/
  - /latest/ZNbase-platform/back-up-restore-universes/restore-universe-data/
menu:
  latest:
...
To restore ZNbaseDB universe YCQL data from a backup, follow these steps.
