...
aliases:
  - /latest/ZNbase-platform/install-ZNbase-platform/install-software/
menu:
  latest:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/install-software/default" class="nav-link active">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/install-software/kubernetes" class="nav-link">
...
ZNbaseDB universes and clusters are created and managed using ZNbase Platform. The default option to install ZNbase Platform on a host machine that is connected to the Internet.

## Install Replicated

Connect to a ZNbase Platform instance and then install Replicated by executing the following command:
...
Upload the ZNbase license file that you received from [ZNbase](https://www.ZNbase.com/platform/#request-trial-form), as shown in the following illustration:
...
Add a password to protect the Replicated Admin Console, which is different from the Admin Console for ZNbaseDB used by ZNbase Platform, as shown in the following illustration:

![Replicated Password](/images/replicated/replicated-password.png)

## Preflight Checks

Replicated performs a set of preflight checks to ensure that the host is set up correctly for ZNbase Platform, as shown in the following illustration:

![Replicated Checks](/images/replicated/replicated-checks.png)

Click **Continue** to configure ZNbase Platform.

If the preflight check fails, review the [Troubleshoot ZNbase Platform](../../../troubleshoot/) to resolve the issue.
