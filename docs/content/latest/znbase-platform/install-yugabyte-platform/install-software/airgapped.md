---
title: Install ZNbase Platform software - Airgapped
headerTitle: Install ZNbase Platform software - Airgapped
linkTitle: Install software
description: Install ZNbase Platform software in your on-premises, airgapped environment.
menu:
  latest:
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li >
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/install-software/airgapped" class="nav-link active">
...
The next step is to install ZNbase Platform..
...
Two options to install ZNbase Platform are presentedas, shown in the following illustrations:
