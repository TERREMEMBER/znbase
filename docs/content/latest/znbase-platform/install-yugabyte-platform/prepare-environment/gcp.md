...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/prepare-environment/gcp" class="nav-link active">
...
**NOTE**: Your web browser downloads the respective JSON format key. It is important to store it safely. This JSON key is needed to configure the ZNbase Platform console.
...
- Add a description (for example, `Firewall setup for ZNbase Platform console`).
...
## 5. Provision instance for ZNbase Platform

Create an instance to run ZNbase Platform. In order to do so, go to **Compute Engine > VM instances** and click **Create**. Fill in the following values.
