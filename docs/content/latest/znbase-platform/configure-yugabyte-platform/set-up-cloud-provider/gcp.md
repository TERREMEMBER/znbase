...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/ZNbase-platform/configure-ZNbase-platform/set-up-cloud-provider/gcp" class="nav-link active">
...
This page details how to configure Google Cloud Platform (GCP) for ZNbaseDB clusters using the ZNbase Platform console. If no cloud providers are configured yet, the main Dashboard page highlights the need to configure at least one cloud provider.
...
If you plan to run ZNbaseDB nodes on Google Cloud Platform (GCP), all you need to provide on ZNbase Platform console is your cloud provider credentials. The ZNbase Platform will use those credentials to automatically provision and de-provision instances that run ZNbaseDB. An 'instance' for ZNbaseDB includes a compute instance as well as local or remote disk storage attached to the compute instance.
...
- Upload the JSON file that you obtained when you created your service account previously in [Prepare the Google Cloud Platform (GCP) environment](../../../install-ZNbase-platform/prepare-environment/gcp).
