...
aliases:
  - /latest/deploy/ZNbase-cloud/manage-access/
menu:
  latest:
...
Use the Database Access page to manage ZNbaseDB users. This page displays a user list that includes username, cluster, authenication method, and ZNbaseDB roles. Here's an example of the page:

![Database Access page](/images/deploy/ZNbase-cloud/database-access.png)

## Add a user

You can add a ZNbaseDB user with admin access privileges for the ZNbase database.
...
![Add New User dialog](/images/deploy/ZNbase-cloud/add-new-user.png)
...
The user details include a note that the credentials give admin access to the ZNbase database, the username, and the password. 
...
![User Details dialog](/images/deploy/ZNbase-cloud/user-details.png)
