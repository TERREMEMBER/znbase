...
description: Configure a CLion project for building ZNbaseDB using cmake or ninja.
...
There are two options for build systems that you can use with ZNbaseDB, `cmake` and `ninja`.
...
### Configure a CLion project for ZNbaseDB
...
3. Use **“File / Reload CMake Project"** - it should start building third party dependencies for ZNbaseDB. 
