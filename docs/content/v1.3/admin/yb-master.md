...
`yb-master`, located in the `bin` directory of ZNbase home, is the [YB-Master](../../architecture/concepts/universe/#yb-master-process) binary.
...
`--webserver_doc_root`| N | The `www` directory in the ZNbaseDB home directory | Monitoring web server home.
