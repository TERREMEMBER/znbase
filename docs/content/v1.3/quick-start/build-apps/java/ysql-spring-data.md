...
The source for the above application can be found in the [repo](https://github.com/ZNbase/orm-examples/tree/master/java/spring/src/main/java/com/ZNbase/springdemo).
...
As highlighted earlier, the source for the above application can be found in the [orm-examples](https://github.com/ZNbase/orm-examples/tree/master/java/spring/src/main/java/com/ZNbase/springdemo) repo.
