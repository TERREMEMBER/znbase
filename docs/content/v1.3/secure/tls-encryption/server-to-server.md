...
-------------------------------|--------------------------|------------------------------|
`use_node_to_node_encryption`  | YB-Master, YB-TServer | Optional, default value is `false`. Set to `true` to enable encryption between the various ZNbaseDB server processes. |
...
You can read more about bringing up the YB-Masters for a deployment in the section on [manual deployment of a ZNbaseDB cluster](../../../deploy/manual-deployment/start-masters/).
...
You can read more about bringing up the YB-TServers for a deployment in the section on [manual deployment of a ZNbaseDB cluster](../../../deploy/manual-deployment/start-tservers/).
