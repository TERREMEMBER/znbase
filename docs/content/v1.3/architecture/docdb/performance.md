...
For correctness, in addition to disabling the WAL mechanism in RocksDB, ZNbase tracks the Raft
...
overhead. ZNbase does not use RocksDB’s sequence ids, and instead uses hybrid-timestamps that are
