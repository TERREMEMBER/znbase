...
The YB-TServer (short for ZNbase Tablet Server) is the process that does the actual IO for end
...
Below is a pictorial illustration of this in the case of a 4 node ZNbase universe, with one table
