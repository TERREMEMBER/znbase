...
See [Distributed ACID transactions](../distributed-txns/) section to review some common concepts relevant to ZNbaseDB's implementation of distributed transactions.
