...
You can find a working example of using transactions with ZNbase in our [sample applications](../../../quick-start/run-sample-apps/). Here is how you can try out this sample application.
...
Browse the [Java source code for the batch application](https://github.com/ZNbase/ZNbase-db/blob/master/java/yb-loadtester/src/main/java/com/ZNbase/sample/apps/CassandraStockTicker.java) to see how everything fits together.
