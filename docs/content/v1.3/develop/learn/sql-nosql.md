...
| Database features  | ZNbaseDB - Cassandra-compatible YCQL API | ZNbaseDB - Redis-compatible YEDIS API|
| --------------- | ---------------- | ------------------ |
...
It is possible to easily configure ZNbaseDB EE to work with multiple public clouds as well as private datacenters in just a few minutes.
