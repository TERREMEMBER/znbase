...
headcontent: Backing up data in ZNbaseDB.
block_indexing: true
menu:
  v1.3:
...
This page covers backups for ZNbaseDB. Here are some points to keep in mind.
...
Dump the keyspace schema (optional) as well as the data in the tables to create a backup of the data in ZNbaseDB. Here are some points to bear in mind.
