...
In this tutorial, we will show how to connect TablePlus with all the 3 ZNbaseDB APIs on a local cluster. TablePlus works without any issues with ZNbaseDB because the ZNbaseDB APIs are compatible at the wire protocol level with databases already supported by TablePlus.
