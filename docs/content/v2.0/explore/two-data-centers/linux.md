...
- ZNbaseDB is installed and ready for use. If you are new to ZNbaseDB, you can create a local ZNbaseDB cluster in under five minutes by following the steps in the [Quick start](../../../quick-start/install/).
