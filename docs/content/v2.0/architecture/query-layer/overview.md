...
title: Overview
linkTitle: Overview
description: Overview of ZNbase Query Layer (YQL)
block_indexing: true
menu:
  v2.0:
...
The YQL layer running inside each YB-TServer implements some of the API specific aspects of each support API, but ultimately replicates/stores/retrieves/replicates data using DocDB, ZNbaseDB’s common underlying strongly-consistent and distributed store. Some of the subcomponents in YQL for each API are:
