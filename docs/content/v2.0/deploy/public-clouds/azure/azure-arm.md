...
1. Create a resource group for our ZNbaseDB deployment.
  ...
  2. Create an SSH key for our user to get access to deployed ZNbaseDB VMs.
     ...
     - Once you select a location for the key, you’ll be prompted to enter an optional passphrase which encrypts the private key file on disk.
       ...
       ```
      - After this, you will have a public and private key that you can use to authenticate ZNbaseDB VM's.
        ```
...
-  Once deployments get compleated, you can access the ZNbaseDB admin from URL you get in the deployment output section.
