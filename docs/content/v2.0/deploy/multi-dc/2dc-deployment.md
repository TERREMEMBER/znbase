...
1. Create the “ZNbase-producer” universe.
...
1. Create the “ZNbase-consumer” universe.
...
Connect to “ZNbase-consumer” universe using the YSQL shell (`ysqlsh`) or the YCQL shell (`cqlsh`), and then confirm that you can see expected records.
