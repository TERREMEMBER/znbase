...
In this tutorial, we are going to use the [Kafka Connect-based Sink Connector for ZNbaseDB](https://github.com/ZNbase/yb-kafka-connector) to store events from Apache Kafka into ZNbaseDB using the [YCQL](../../../api/ycql) API.
