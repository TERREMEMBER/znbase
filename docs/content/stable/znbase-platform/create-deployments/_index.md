---
title: Create ZNbaseDB universe deployments
headerTitle: Create ZNbaseDB universe deployments
linkTitle: Create deployments
description: Create ZNbaseDB universe deployments.
...
<!--
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="create-universe-single-zone/">
      ...
      <div class="body">
        Use ZNbase Platform to create a single-zone universe.
      </div>
    </a>
  </div>
-->
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="create-universe-multi-zone/">
      ...
      <div class="body">
        Use ZNbase Platform to deploy a multi-zone universe.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="create-universe-multi-region/">
      ...
      <div class="body">
        Use ZNbase Platform to deploy a multi-region universe.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="read-replicas/">
      ...
      <div class="body">
        Use ZNbase Platform to create a read-replica cluster for a universe.
      </div>
    </a>
  </div>
