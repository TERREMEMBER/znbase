...
description: Use ZNbase Platform to create a KMS configuration using Equinix SmartKey.
menu:
  stable:
    parent: security
...
Encryption at rest uses universe keys to encrypt and decrypt universe data keys. You can use the ZNbase Platform console to create key management service (KMS) configurations for generating the required universe keys for one or more ZNbaseDB universes. Encryption at rest in ZNbase Platform supports the use of [Equinix SmartKey](https://www.equinix.com/services/edge-services/smartkey/) as a key management service (KMS).
