...
Follow the steps below to customize your ZNbaseDB ports for security purposes.
For a list of ZNbaseDB default ports, see [Default ports reference](../../../reference/configuration/default-ports).
