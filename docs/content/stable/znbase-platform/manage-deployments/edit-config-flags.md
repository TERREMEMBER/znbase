...
description: Use ZNbase Platform to edit configuration flags.
menu:
  stable:
...
The configuration flags for your YB-Master and YB-TServer nodes in a ZNbaseDB universe can be edited and customized to:
...
1. In the ZNbase Platform console, go to the **Universe Detail** page.
