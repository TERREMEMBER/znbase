...
Starting with ZNbaseDB version 2.1.8, Helm 2 is not supported. Follow the steps below to migrate your existing ZNbaseDB universes and the ZNbase Platform from Helm 2 to Helm 3.
