---
title: Use ZNbase Platform to add a node
headerTitle: Add a node
linkTitle: Add a node
description: Use ZNbase Platform to add a node.
menu:
  stable:
