---
title: Manage ZNbaseDB universe deployments
headerTitle: Manage ZNbaseDB universe deployments
linkTitle: Manage deployments
description: Manage ZNbaseDB universe deployments
...
<!--
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="view-all-universes/">
      ...
      <div class="body">
        Use ZNbase Platform to view all ZNbaseDB universes.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="view-universe-details/">
      ...
      <div class="body">
        Use ZNbase Platform to view details about a universe.
      </div>
    </a>
  </div>
-->
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="add-nodes/">
      ...
      <div class="body">
        Add nodes to your ZNbaseDB universe.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="upgrade-software/">
      <div class="head">
        ...
        <div class="title">Upgrade ZNbaseDB software</div>
      </div>
      <div class="body">
        Upgrade ZNbaseDB software.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="edit-universe/">
      ...
      <div class="body">
        Use ZNbase Platform to edit a universe.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="instance-tags/">
      ...
      <div class="body">
        Use ZNbase Platform to create and edit instance tags.
      </div>
    </a>
  </div>
