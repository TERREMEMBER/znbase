...
linkTitle: Install ZNbase Platform
description: Install ZNbase Platform and prepare universe nodes.
image: /images/section_icons/quick_start/install.png
headcontent: Install ZNbase Platform to begin creating and managing deployments.
menu:
  stable:
    parent: ZNbase-platform
    identifier: install-ZNbase-platform
weight: 641
isTocNested: true
showAsideToc: true
---
...
<div class="row">
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="prerequisites/">
      ...
      <div class="body">
        Prerequisites for installing ZNbase Platform.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="prepare-environment/">
      ...
      <div class="body">
        Prepare your environment for installing ZNbase Platform.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="install-software/">
      ...
      <div class="body">
        Install ZNbase platform software on a host.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="prepare-on-prem-nodes/">
      ...
      <div class="body">
        Prepare ZNbaseDB nodes for on-premises installation.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="uninstall-software/">
      ...
      <div class="body">
        Uninstall ZNbase platform software on a host.
      </div>
    </a>
  </div>
