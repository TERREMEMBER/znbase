...
description: Prepare the Azure environment for the ZNbase Platform.
...
<ul class="nav nav-tabs-alt nav-tabs-yb">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/prepare-environment/aws" class="nav-link">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/prepare-environment/gcp" class="nav-link">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/prepare-environment/azure" class="nav-link active">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/prepare-environment/kubernetes" class="nav-link">
  ...
  <li>
    <a href="/latest/ZNbase-platform/install-ZNbase-platform/prepare-environment/on-premises" class="nav-link">
...
You can skip creating a new resource group and [use an existing one to manage ZNbase Platform resources](
...
![Prepare Azure cloud to install ZNbase Platform](/images/yb-platform/install/azure/platform-azure-prepare-cloud-env-1.png)
...
![Prepare Azure cloud to install ZNbase Platform](/images/yb-platform/install/azure/platform-azure-prepare-cloud-env-2.png)
...
![Prepare Azure cloud to install ZNbase Platform](/images/yb-platform/install/azure/platform-azure-prepare-cloud-env-3.png)
...
## Provision instance for ZNbase Platform

Create an instance to run the ZNbase Platform server. To do so, go to Virtual Machines>Add and Fill in the following values.
...
Finally, click Review+create to launch the ZNbase Platform VM.
