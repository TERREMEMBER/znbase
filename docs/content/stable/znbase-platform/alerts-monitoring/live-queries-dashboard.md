...
Use the Live Queries dashboard to monitor and display current running queries on your ZNbaseDB universes. You can use this data to:
...
| Column                     | Description                                                  |
| -------------------------- | ------------------------------------------------------------ |
| Node Name                  | The YB-TServer node name generated by ZNbase Platform      |
