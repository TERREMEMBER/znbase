...
description: Use ZNbase Platform to back up and restore ZNbaseDB universe data.
image: /images/section_icons/manage/backup.png
headcontent: Use ZNbase Platform to back up and restore ZNbaseDB universes and data.
menu:
  stable:
...
<div class="row">
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="configure-backup-storage/">
      ...
      <div class="body">
        Use ZNbase Platform to configure the storage location for your universe data.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="back-up-universe-data/">
      ...
      <div class="body">
        Use ZNbase Platform to restore universe data.
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-12 col-xl-6">
    <a class="section-link icon-offset" href="schedule-data-backups/">
      ...
      <div class="body">
        Use ZNbase Platform to schedule backups of universe data.
      </div>
    </a>
  </div>
