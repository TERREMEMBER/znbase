...
description: Benchmark scaling YSQL queries in ZNbaseDB
menu:
  stable:
...
```sh
$ wget -P target https://github.com/ZNbase/yb-sample-apps/releases/download/1.3.1/yb-sample-apps.jar
```
