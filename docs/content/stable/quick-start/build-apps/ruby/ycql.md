...
linkTitle: Ruby
description: Build a sample Ruby application with the ZNbase Ruby Driver for YCQL.
menu:
  stable:
    parent: build-apps
    name: Ruby
...
## Install the ZNbase Ruby Driver for YCQL

To install the [ZNbase Ruby Driver for YCQL](https://github.com/ZNbase/cassandra-ruby-driver), run the following `gem install` command:
