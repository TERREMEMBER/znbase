...
This page shows how Presto can be setup to query ZNbaseDB's YCQL tables.

## 1. Start local cluster

Follow [Quick start](../../../quick-start/) instructions to run a local ZNbaseDB cluster. Test ZNbaseDB's Cassandra compatible API as [documented](../../../quick-start/test-cassandra/) so that you can confirm that you have a Cassandra compatible service running on `localhost:9042`. We assume you have created the keyspace and table, and inserted sample data as described there.
...
### Configure Cassandra connector to ZNbaseDB
