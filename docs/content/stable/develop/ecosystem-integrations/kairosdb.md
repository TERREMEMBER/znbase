...
Follow [Quick start](../../../quick-start/) to run a local ZNbaseDB cluster and test ZNbaseDB's YCQL API to confirm that you have a YCQL service running on `localhost:9042`.
...
Run `ycqlsh` to connect and use ZNbaseDB's YCQL API.
