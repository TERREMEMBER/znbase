...
To build your Java application using the ZNbaseDB Java driver for YCQL, add the following sbt dependency to your application:

```sbt
libraryDependencies += "com.ZNbase" % "cassandra-driver-core" % "3.2.0-yb-19"
```
