...
Use the steps below to deploy a read replica cluster using ZNbaseDB. For information on deploying read replica clusters using the ZNbase Platform, see [Read replicas](../../../manage/enterprise-edition/read-replicas/).
