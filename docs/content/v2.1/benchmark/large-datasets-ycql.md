...
headcontent: Benchmark ZNbaseDB with large data sets.
block_indexing: true
menu:
  v2.1:
...
Use this benchmark to understand the performance, failure, and scaling characteristics of ZNbaseDB with a massive dataset (multiple TB per node). In order to accomplish that, you will do the following:
