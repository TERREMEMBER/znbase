...
function(ENFORCE_OUT_OF_SOURCE_BUILD)
  if("${CMAKE_CURRENT_SOURCE_DIR}" STREQUAL "${CMAKE_CURRENT_BINARY_DIR}")
    message(FATAL_ERROR
      "ZNbase may not be built from the top-level source directory. Create a new "
...
# A wrapper around add_library() for ZNbaseDB libraries.
#
# Required arguments:
#
...
# See https://github.com/ZNbase/ZNbase-db/issues/5853: we currently have to run this function
