...
import com.ZNbase.yw.commissioner.tasks.subtasks.nodes.UpdateNodeProcess;

import com.ZNbase.yw.common.services.YBClientService;
import com.ZNbase.yw.forms.UniverseTaskParams.EncryptionAtRestConfig.OpType;
    ...
    for (NodeDetails node : nodes) {
      ...
      if (node.cloudInfo.private_ip == null){
        ...
        if (node.cloudInfo.cloud.equals(
            com.ZNbase.yw.commissioner.Common.CloudType.onprem.name())) {
          try {
