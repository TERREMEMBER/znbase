...
import com.ZNbase.yw.commissioner.tasks.CloudBootstrap;
import com.ZNbase.yw.commissioner.tasks.CloudCleanup;
import com.ZNbase.yw.commissioner.tasks.params.CloudTaskParams;
import com.ZNbase.yw.commissioner.tasks.params.KubernetesClusterInitParams;
...
import com.ZNbase.yw.forms.CloudProviderFormData;
import com.ZNbase.yw.forms.CloudBootstrapFormData;
import com.ZNbase.yw.forms.KubernetesProviderFormData;
import com.ZNbase.yw.forms.KubernetesProviderFormData.RegionData;
import com.ZNbase.yw.forms.KubernetesProviderFormData.RegionData.ZoneData;
...
import static com.ZNbase.yw.common.ConfigHelper.ConfigType.DockerInstanceTypeMetadata;
import static com.ZNbase.yw.common.ConfigHelper.ConfigType.DockerRegionMetadata;
import static com.ZNbase.yw.models.helpers.CommonUtils.DEFAULT_YB_HOME_DIR;
    ...
    try {
      ...
      regionMetadata.forEach((regionCode, metadata) -> {
        ...
        Arrays.asList("a", "b", "c").forEach((zoneSuffix) -> {
          ...
          AvailabilityZone.create(region, zoneName, zoneName, "ZNbase-bridge");
        });
      });
