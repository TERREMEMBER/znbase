 ...
 *
 * https://github.com/ZNbase/ZNbase-db/blob/master/licenses/POLYFORM-FREE-TRIAL-LICENSE-1.0.0
 * .txt
 */
...
import com.ZNbase.yw.controllers.HAAuthenticator;
import com.ZNbase.yw.controllers.ReverseInternalHAController;
import com.ZNbase.yw.models.HighAvailabilityConfig;
...
public class PlatformInstanceClient {
  ...
  /**
   * calls {@link com.ZNbase.yw.controllers.InternalHAController#getHAConfigByClusterKey()}
  ...
  /**
   * calls {@link com.ZNbase.yw.controllers.InternalHAController#syncInstances(long timestamp)}
   * on remote platform instance
   *
  ...
  /**
   * calls
   * {@link com.ZNbase.yw.controllers.InternalHAController#demoteLocalLeader(long timestamp)}
   * on remote platform instance
   */
