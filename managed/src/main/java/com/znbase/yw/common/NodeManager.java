...
import com.ZNbase.yw.commissioner.tasks.subtasks.AnsibleClusterServerCtl;
import com.ZNbase.yw.commissioner.tasks.subtasks.AnsibleConfigureServers;
import com.ZNbase.yw.commissioner.tasks.subtasks.AnsibleDestroyServer;
import com.ZNbase.yw.commissioner.tasks.subtasks.PauseServer;
import com.ZNbase.yw.commissioner.tasks.subtasks.ResumeServer;
import com.ZNbase.yw.commissioner.tasks.subtasks.AnsibleSetupServer;
import com.ZNbase.yw.commissioner.tasks.subtasks.InstanceActions;
...
import static com.ZNbase.yw.commissioner.tasks.UniverseDefinitionTaskBase.*;
...
public class NodeManager extends DevopsBase {
  ...
  private List<String> getAccessKeySpecificCommand(NodeTaskParams params, NodeCommandType type) {
    ...
    if (userIntent != null && !userIntent.accessKeyCode.equalsIgnoreCase("ZNbase-default")) {
    ...
    switch(taskParam.type) {
      case Everything:
        ...
        if (ybServerPackage == null) {
          throw new RuntimeException("Unable to fetch ZNbase release for version: " +
        ...
        if ((taskParam.enableNodeToNodeEncrypt || taskParam.enableClientToNodeEncrypt)) {
          ...
          extra_gflags.put("certs_dir", yb_home_dir + "/ZNbase-tls-config");
          subcommand.add("--certs_node_dir");
          subcommand.add(yb_home_dir + "/ZNbase-tls-config");
