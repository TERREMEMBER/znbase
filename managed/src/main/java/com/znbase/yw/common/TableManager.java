...
import static com.ZNbase.yw.common.TableManager.CommandSubType.DELETE;
...
public class TableManager extends DevopsBase {
  ...
  private static final String VM_CERT_DIR = "/ZNbase-tls-config/";
  ...
  public ShellResponse runCommand(CommandSubType subType,
    ...
    switch (subType) {
      ...
      // Tracked by issue: https://github.com/ZNbase/ZNbase-db/issues/1864
      case BULK_IMPORT:
        commandArgs.add("--table");
        commandArgs.add(taskParams.tableName);
        commandArgs.add("--keyspace");
