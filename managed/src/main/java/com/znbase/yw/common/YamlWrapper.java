package com.ZNbase.yw.common;// Copyright (c) ZNbase, Inc.
...
public class YamlWrapper {
  ...
  /**
   * Load a com.ZNbase.yw.common.Yaml file from the classpath.
   */
  ...
  /**
   * Load the specified InputStream as com.ZNbase.yw.common.Yaml.
   *
