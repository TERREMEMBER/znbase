...
import static com.ZNbase.yw.common.ConfigHelper.ConfigType.SoftwareReleases;
...
public class ReleaseManagerTest {
  ...
  private void createDummyReleases(
    ...
    versions.forEach((version) -> {
      ...
      createTempFile(
        versionPath, "ZNbase-" + eeStr + version + "-centos-x86_64.tar.gz", "Sample data");
      if (multipleRepos) {
        createTempFile(
  ...
  public void testLoadReleasesWithReleasePath() {
    ...
    Map expectedMap = ImmutableMap.of(
        "0.0.1", TMP_STORAGE_PATH + "/0.0.1/ZNbase-ee-0.0.1-centos-x86_64.tar.gz");
  ...
  public void testLoadReleasesWithReleaseAndDockerPath() {
    ...
    Map expectedMap = ImmutableMap.of(
        "0.0.1", TMP_STORAGE_PATH + "/0.0.1/ZNbase-ee-0.0.1-centos-x86_64.tar.gz",
        "0.0.2-b2", TMP_STORAGE_PATH + "/0.0.2-b2/ZNbase-ee-0.0.2-b2-centos-x86_64.tar.gz",
        "0.0.3-b3", TMP_STORAGE_PATH + "/0.0.3-b3/ZNbase-0.0.3-b3-centos-x86_64.tar.gz"
    );
  ...
  public void testGetReleaseByVersionWithConfig() {
    ReleaseManager.ReleaseMetadata metadata =
        ReleaseManager.ReleaseMetadata.fromLegacy("0.0.1", "/path/to/ZNbase-0.0.1.tar.gz");
    ...
    assertThat(release.filePath, allOf(notNullValue(),
        equalTo("/path/to/ZNbase-0.0.1.tar.gz")));
  }
  ...
  public void testGetReleaseByVersionWithLegacyConfig() {
    ...
    releases.put("0.0.1", "/path/to/ZNbase-0.0.1.tar.gz");
