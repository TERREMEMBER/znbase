...
import com.ZNbase.yw.commissioner.tasks.UpgradeUniverse;
import com.ZNbase.yw.commissioner.tasks.params.NodeTaskParams;
import com.ZNbase.yw.commissioner.tasks.subtasks.*;
import com.ZNbase.yw.forms.CertificateParams;
...
import com.ZNbase.yw.forms.UniverseDefinitionTaskParams.ClusterType;
import com.ZNbase.yw.forms.UniverseDefinitionTaskParams.UserIntent;
import com.ZNbase.yw.models.*;
import com.ZNbase.yw.models.helpers.CloudSpecificInfo;
...
import static com.ZNbase.yw.commissioner.tasks.UniverseDefinitionTaskBase.ServerType.MASTER;
import static com.ZNbase.yw.commissioner.tasks.UniverseDefinitionTaskBase.ServerType.TSERVER;
import static com.ZNbase.yw.commissioner.tasks.UpgradeUniverse.UpgradeTaskSubType.Download;
import static com.ZNbase.yw.commissioner.tasks.UpgradeUniverse.UpgradeTaskSubType.Install;
import static com.ZNbase.yw.commissioner.tasks.UpgradeUniverse.UpgradeTaskType.*;
import static com.ZNbase.yw.common.TestHelper.createTempFile;
      ...
      case Configure:
        ...
        if (configureParams.type == Everything) {
          ...
          if (configureParams.enableNodeToNodeEncrypt || configureParams.enableClientToNodeEncrypt) {
            ...
            gflags.put("certs_dir", "/home/ZNbase/ZNbase-tls-config");
            expectedCommand.add("--certs_node_dir");
            expectedCommand.add("/home/ZNbase/ZNbase-tls-config");
    ...
    for (TestData t : testData) {
      ...
      try {
        ...
        assertThat(re.getMessage(), allOf(notNullValue(),
            is("Unable to fetch ZNbase release for version: 0.0.2")));
      }
    }
  }
