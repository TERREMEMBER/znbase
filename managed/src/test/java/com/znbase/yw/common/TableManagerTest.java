...
import com.ZNbase.yw.forms.BulkImportParams;
...
import static com.ZNbase.yw.common.TableManager.CommandSubType.BACKUP;
import static com.ZNbase.yw.common.TableManager.CommandSubType.BULK_IMPORT;
import static com.ZNbase.yw.common.TableManager.PY_WRAPPER;
...
@RunWith(MockitoJUnitRunner.class)
  ...
  private static final String K8S_CERT_PATH = "/opt/certs/ZNbase/";
  private static final String VM_CERT_PATH = "/home/ZNbase/ZNbase-tls-config/";
  ...
  public void testBulkImportWithIncorrectYBVersion() {
    ...
    try {
      ...
      assertEquals("Unable to fetch ZNbase release for version: 0.0.2", re.getMessage());
    }
  }
