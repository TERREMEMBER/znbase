...
public class CustomerConfigValidatorTest {
  ...
  @Parameters({
    ...
    "S3, BACKUP_LOCATION, s3://backups.ZNbase.com/test/itest, true",
    "S3, AWS_HOST_BASE, s3://backups.ZNbase.com/test/itest, false",  // BACKUP_LOCATION undefined
  ...
  @Parameters({
    ...
    "S3, BACKUP_LOCATION, s3://backups.ZNbase.com/test/itest, AWS_HOST_BASE,, true",
    // location - correct, aws_host_base - incorrect -> disallowed
    "S3, BACKUP_LOCATION, s3://backups.ZNbase.com/test/itest, " +
    ...
    "S3, BACKUP_LOCATION, ftp://backups.ZNbase.com/test/itest, " +
        "AWS_HOST_BASE, s3.amazonaws.com, false",
    // location - incorrect, aws_host_base - empty -> disallowed
    "S3, BACKUP_LOCATION, ftp://backups.ZNbase.com/test/itest, AWS_HOST_BASE,, false",
